...
/**
 * Migration-capability conformance for the YACL adapter identity.
 * <p>
 * {@code AdapterConfigProvider} advertises {@code Capability.MIGRATION}, so
 * per spec §21.2 it MUST extend this class.
 */
public final class YaclMigrationConformanceTest extends AbstractMigrationCapabilityTest {

    //==================================================
    // Constructors
    //==================================================

    public YaclMigrationConformanceTest() {
        super();
    }
