...
import com.oliveryasuna.mc.rubric.api.annotation.*;
...
public final class AnnotationSchemaReader {
     ...
     * {@link CodecRegistry#registerLeaf(Class, com.oliveryasuna.mc.rubric.value.ValueCodec)}.
     ...
     * {@link com.oliveryasuna.mc.rubric.value.ValueType.Kind#SCALAR} rather
