...
import com.oliveryasuna.mc.omniconfig.api.annotation.Config;
import com.oliveryasuna.mc.omniconfig.api.annotation.Range;

@Config(id = "omniconfig", name = "OmniConfig")
public final class OmniConfigConfig {
